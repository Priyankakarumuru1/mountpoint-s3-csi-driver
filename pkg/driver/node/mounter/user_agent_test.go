...
func TestUserAgent(t *testing.T) {
	tests := map[string]struct {
		...
		"with eks self-managed distribution": {
			...
			result:               "s3-csi-driver/ credential-source#driver k8s/v1.30.2-eks-db838b0 distribution/eks",
		},
		...
		"with openshift distribution": {
			...
			result:               "s3-csi-driver/ credential-source#pod k8s/v4.13.5 distribution/openshift",
		},
	}
